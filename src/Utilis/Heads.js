...
const Heads = () => {
    return (
        <Head>
            <meta property="og:url" content="https://eureka" />
            <meta property="og:type" content="website" />
            <meta property="og:title" content="Eureka | Web and Mobile application developing agency" />
            ...
            <meta name="author" content="Semsfan" />
        </Head>
    );
};
