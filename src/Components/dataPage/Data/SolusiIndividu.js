...
//   },
  ...
  {
    title: 'Hobby and Cars',
    description: 'Temukan hobi menarikmu pada unit bisnis kami yang bernama jaja.id! Tidak hanya hobi anda yang kami sediakan, Jaja.id juga memiliki fokus pada penjualan mobil untuk kebutuhan anda. New Car',
    icon: Jajaicon,
  },
];
...
export const testimonials = [
  {
    name: 'Steven Wongso',
    title: 'Direktur PT. Indo Jaya Abadi Sejahtera',
    feedback: 'Eureka merupakan partner kerja yang baik, dapat mencari solusi dengan cepat dan kerjanya professional. Untuk anda jangan ragu dan sungkan menggunakan jasa mereka karena mereka sangat amat kompeten dalam bidang yang anda butuhkan!',
    rating: 5,
  },
  {
    name: 'Steven Wongso',
    title: 'Direktur PT. Indo Jaya Abadi Sejahtera',
    feedback: 'Eureka Group is the best partner i ever had! with Knowledge they bring my dream comes into reallity. Not only focus on goals, they care about the process. Good Job for Eureka Group! Hope we can work together for more long way! #SalamVicotory!',
    rating: 5,
  },
  {
    name: 'Steven Wongso',
